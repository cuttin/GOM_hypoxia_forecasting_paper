...
(date_now <- Sys.Date())
ggsave(filename = paste0('Q:\\My Drive\\research\\transfered from Katin\\GOM model\\Clean\\data\\study site map\\fig_1_v5_', date_now, '.pdf'),  
       plot = finplot,   
       dpi = 500, width = 20, height = 10, units = c("cm"))
#######################################################################################
ggsave(filename = paste0('Q:\\My Drive\\research\\transfered from Katin\\GOM model\\Clean\\data\\study site map\\fig_1_v5_', date_now, '.png'),  
       plot = finplot,   
       dpi = 500, width = 20, height = 10, units = c("cm"))
